...
<div class="container my-3">
    ...
    <!--    start form-->
<!--    action is important that what sql do u want to execute-->
    <form action="edit.jsp"  method="post">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="givenName" name="givenName" placeholder="First Name" value="<%=s.getGivenName()%>"/>
            </div>

            <div class="col-md-6">
                <label for="exampleInputEmail1" class="form-label">Last Name</label>
                <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Last Name"value="<%=s.getLastName()%>"/>
            </div>        
        </div>
        <!-- start 2nd row-->
        <div class="row mt-3">
            ...
            <div class="col-md-6">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="flexRadioDefault1" <%=s.getGender().equals("Male")?"checked":""%>>
                        Male
                    </label>
                </div>
                <div class="form-check">
